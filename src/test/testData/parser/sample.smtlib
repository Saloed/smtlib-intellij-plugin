...
(set-option :fp.spacer.simplify_pob true)
                ...
                (declare-fun function_argument_predicate__0
             (Int Int Int (Array Int Int) Int Int Int Int)
             Bool)
(assert (forall ((arg$1 Int)
         (call__0__result Int)
         (%3 Int)
         (%0 Int)
         (call__1__result Int)
         (%8 Int)
         (%4 Int)
         (__property__org/jetbrains/research/kex/test/refinements/Inlining$SampleCls.x__0 (Array Int
                                                                                                 Int))
         (%1 Bool)
         (this Int)
         (<retval> Int)
  ...
  (let ((a!1 (or false
        ...
        (a!4 (<= (+ arg$0
                    (* (- 1)
                       (select __property__org/jetbrains/research/kex/test/refinements/Inlining$SampleCls.x__0
                               %5)))
                 0))
  ...
  (let ((a!7 (and (or false
                  ...
                  (= %7 false))))
    (=> a!7
        (function_argument_predicate__0
          arg$1
          call__0__result
          call__1__result
          __property__org/jetbrains/research/kex/test/refinements/Inlining$SampleCls.x__0
          this
          call__3__result
          call__2__result
          arg$0)))))))
(assert (forall ((arg$1 Int)
  ...
  (let ((a!7 (and (or false
                  ...
                  true
                  (= %7 true)
                  (or (function_argument_predicate__0
                        arg$1
                        call__0__result
                        call__1__result
                        __property__org/jetbrains/research/kex/test/refinements/Inlining$SampleCls.x__0
