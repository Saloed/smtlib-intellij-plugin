                   ...
                   (let
                       ...
                       (let
                           ...
                           (a!7 (and
                                    ...
                                    true
                                    (= %7 true)
                                    (or (function_argument_predicate__0 arg$1 call__0__result call__1__result __property__org/jetbrains/research/kex/test/refinements/Inlining$SampleCls.x__0 this call__3__result call__2__result arg$0))
                                ))
                           )
                           (=> a!7 false)
                       )
